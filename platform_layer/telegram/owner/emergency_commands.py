...
own docstring. NOT registered into platform_layer/telegram/commands.py, NOT called
from platform_layer/telegram/command_router.py or platform_layer/telegram/handlers.py.
