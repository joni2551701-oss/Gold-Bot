...
USER), which is live-wired into platform_layer/telegram/command_router.py's real,
...
platform_layer/telegram/owner/ checks OwnerRole yet; wiring a real per-command
...
class OwnerRole(Enum):
    """
    OWNER: the single configured owner (platform_layer.telegram.permissions.is_owner()) --
