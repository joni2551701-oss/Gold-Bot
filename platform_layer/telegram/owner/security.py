...
boundary platform_layer/telegram/owner/README.md already documents for
`platform_layer.telegram.owner.owner_roles.OwnerRole` itself.
...
# Same tiering platform_layer/telegram/command_router.py's own _PERMISSION_RANK
...
def require_role(telegram_id, minimum_role: OwnerRole, admin_repository=None) -> SecurityCheckResult:
    ...
    platform_layer.telegram.owner.owner_roles.resolve_owner_role(), reused unmodified)
