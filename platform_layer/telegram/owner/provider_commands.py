...
into platform_layer/telegram/commands.py's OWNER_COMMANDS/ADMIN_COMMANDS dicts, NOT
wired into platform_layer/telegram/command_router.py's routing or platform_layer/telegram/handlers.py.
...
Mirrors platform_layer/telegram/admin_service.py's own shape (a service class with
