...
platform_layer/telegram/permissions.py) -- only admin CRUD, statistics aggregation,
...
class AdminService:
    ...
    async def broadcast(self, message: str) -> AdminServiceResult:
        ...
        and runs inside platform_layer/telegram/polling.py's already-active event
