...
the plan check (platform_layer.telegram.permissions is the single source of truth
...
decision -- see platform_layer/telegram/handlers.py's history_handler() docstring):
...
from platform_layer.telegram.permissions import is_admin
