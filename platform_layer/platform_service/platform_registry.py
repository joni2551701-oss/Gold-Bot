...
Foundation Reuse Audit: see `platform_layer/platform_service/platform_model.py`'s docstring
...
DEFAULT_PLATFORMS = (
    PlatformDefinition(
        ...
        compatibility="platform_layer/telegram/polling.py — see docs/PLATFORM_ARCHITECTURE.md",
    ),
    PlatformDefinition(
