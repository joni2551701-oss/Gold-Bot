...
`conversation_id` is a pointer into `ai.session.SessionManager`'s own
...
- `voice/`, `ai/conversation/`, `ai/memory/`,
  `ai/intelligence_runtime.py` — the LOCKed packages
