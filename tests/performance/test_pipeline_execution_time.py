...
def test_pipeline_stage_timing_is_logged(mock_pipeline, mock_signal_candidate, mock_ai_result, caplog):
    ...
    for stage in ("market_data", "data_quality", "htf_bias", "context", "market_phase", "features", "signal", "signal_quality", "explainability", "ai", "decision", "risk", "signal_history", "telegram_format", "database"):
