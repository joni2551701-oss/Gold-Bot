"""PLATFORM-001 -- Universal Navigation model foundation tests (platforms/)."""

from platforms.navigation_model import NavigationNode
from platforms.platform_model import PlatformName


def test_navigation_node_defaults():
    node = NavigationNode(id="main", label_key="menu.main", permission="USER")
