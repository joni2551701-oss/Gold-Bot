...
(strategies/*.py, signal_layer/signal_engine/signal_engine.py) is entirely untouched --
...
if TYPE_CHECKING:
    ...
    from signal_layer.signal_scoring.signal_quality import SignalQualityResult
...
def from_signal_candidate(
    ...
    *,
    ...
    and already the same value strategy_layer.strategy_manager.lifecycle.strategy_registry.StrategyDefinition.id
    ...
    (decision_layer.decision_engine.models.TradeDecision has no id field of its own) --
