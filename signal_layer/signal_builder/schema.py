...
Review's AC-03 task -- see signal_layer/signal_builder/adapter.py and core/pipeline.py's
"Signal <-> Context Historical Link" stage. See signal_layer/signal_builder/adapter.py for
...
# itself has no equivalent for. signal_layer/signal_builder/adapter.py documents the exact
