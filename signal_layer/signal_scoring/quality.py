...
Reuse, not a second grader: signal_layer/signal_scoring/signal_quality.py already computes a
...
# A+/A/B/C (signal_layer.signal_scoring.signal_quality.QualityGrade.value) -> coarse label.
_GRADE_TO_STRENGTH = {
