...
Fetches candles from an existing MarketDataProvider (data_layer/providers/,
...
data_layer.providers.twelve_data_client.TwelveDataClient.fetch_candles() nor
...
# outputsize -- see data_layer/providers/twelve_data_client.py's own BASE_URL/params
