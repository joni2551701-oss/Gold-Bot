...
with the existing frozen `data_layer.providers.twelve_data_client.Candle` via
...
class CandleRecord:
    ...
    def to_candle(self) -> Candle:
        ...
        `data_layer.providers.twelve_data_client.Candle`) for interop with the rest of
