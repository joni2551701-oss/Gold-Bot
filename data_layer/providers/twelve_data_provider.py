...
data_layer/providers/twelve_data_client.py's TwelveDataClient (not "data/twelve_data.py",
...
it needs to be moved"), and data_layer/providers/twelve_data_client.py is imported
directly by data_layer/live_data/market_data.py (the live pipeline's data source) and
...
# only -- data_layer/providers/twelve_data_client.py's own _format_symbol() already
...
class TwelveDataProvider(MarketDataProvider):
    ...
    def get_candles(self, symbol: str, timeframe: str, limit: int) -> List[MarketCandle]:
        ...
        re-raised -- unlike data_layer/live_data/market_data.py's get_candles(), this
