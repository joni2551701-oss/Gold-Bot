# CHANGELOG.md — data_layer/snapshots/catalog
...
### Changed
- Converted from flat `catalog.py` to package `catalog/` (GEL-001 Strict). No behavioural change; implementation moved intact.
