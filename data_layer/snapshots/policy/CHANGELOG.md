# CHANGELOG.md — data_layer/snapshots/policy
...
### Changed
- Converted from flat `policy.py` to package `policy/` (GEL-001 Strict). No behavioural change; implementation moved intact.
