# CHANGELOG.md — data_layer/snapshots/manager
...
### Changed
- Converted from flat `manager.py` to package `manager/` (GEL-001 Strict). No behavioural change; implementation moved intact.
