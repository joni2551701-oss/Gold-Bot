# IMPLEMENTATION.md -- data_layer/live_data/current_price_provider

## `current_price_provider.py`

Current Price Provider (TASK‑CORE‑004 Phase 1, Director Decision 1;

Classes: `CurrentPrice`, `LastPriceSource`, `SmartCacheLastPriceSource`, `PriceStreamLastPriceSource`, `CurrentPriceProvider`

Top-level functions: `build_default_current_price_provider()`
