...
Tasdiq: haqiqiy `backtesting_layer/backtest_engine/backtest_engine.py` importlari ushbu qoidaga allaqachon mos — u `risk_layer.risk_engine.risk_manager.RiskManager`ni chaqiradi va `execution/` yoki biror Broker mijozini umuman import qilmaydi.
---
## Module Reuse Rule
```text
