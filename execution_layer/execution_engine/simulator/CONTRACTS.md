# CONTRACTS.md -- execution_layer/execution_engine/simulator
...
Module `execution_layer/execution_engine/simulator`.
...
- `risk_layer.risk_engine`
- `trade_monitoring_layer.paper_trading`
