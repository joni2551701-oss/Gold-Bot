...
TASK 9's own instruction: "Faqat key yasaydi. `ai.memory` import
qilinmaydi" (only builds a key; `ai.memory` is never imported). This
module deliberately never imports `ai.memory` at all -- `ai/memory/models.py`'s
