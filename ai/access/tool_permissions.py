...
matching `ai.tools.tool_registry.BaseAITool.name`'s own values --
...
_DEFAULT_TOOL_MATRIX: Dict[AIRole, FrozenSet[str]] = {
    AIRole.OWNER: frozenset({"market_tool", "news_tool", "analytics_tool", "education_tool"}),
    AIRole.ADMIN: frozenset({"market_tool", "news_tool", "analytics_tool", "education_tool"}),
    AIRole.VIP: frozenset({"market_tool", "news_tool", "analytics_tool", "education_tool"}),
    AIRole.PREMIUM: frozenset({"market_tool", "analytics_tool", "education_tool"}),
