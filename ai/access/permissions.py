...
Not wired to any real user lookup this phase -- `database/user_repository.py`,
`database/admin_repository.py`, and `database/subscription_repository.py`
...
class AIRole(Enum):
    ...
    FREE mirror `database/models.py`'s free-text subscription `plan`
