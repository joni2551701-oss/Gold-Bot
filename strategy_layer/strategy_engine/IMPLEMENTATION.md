# IMPLEMENTATION.md -- strategy_layer/strategy_engine

## `base.py`

Strategies — SetupStrategy base contract (TASK-CORE-007, setup layer).

Classes: `SetupStrategy`

## `result.py`

Strategies — StrategyResult contract (TASK-CORE-007, setup layer).

Classes: `StrategyDirection`, `SetupStatus`, `StrategyResult`

Top-level functions: `compute_rr()`
