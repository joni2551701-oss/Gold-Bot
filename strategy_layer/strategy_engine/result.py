...
signal (see signal_layer/signal_builder/models.py's SignalCandidate for the live signal
contract) and NOT a trade decision. This layer runs alongside the
existing live SignalCandidate path (strategy_layer/strategy_manager/strategy_manager.py),
