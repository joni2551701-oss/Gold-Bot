...
This is DISTINCT from strategy_layer/strategy_manager/strategy_manager.py's StrategyManager,
...
from strategy_layer.strategy_library.registry import SetupRegistry, build_setup_registry
