# CONTRACTS.md -- strategy_layer/strategy_profiles
...
Module `strategy_layer/strategy_profiles`.

## Dependencies

No cross-layer imports found mechanically in this module's own `.py` files at rollout time.
