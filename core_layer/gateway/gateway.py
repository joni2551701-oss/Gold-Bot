...
from core_layer.gateway.authentication import Authenticator
from core_layer.gateway.authorization import Authorizer
...
from core_layer.gateway.version_service import VersionService
from core_layer.gateway.router import GatewayRouter
from core_layer.gateway.gateway_request import GatewayRequest, GatewayResponse
from core_layer.gateway.gateway_events import (
    GatewayEvent, GatewayEventName, EventSink,
)
from core_layer.gateway.gateway_context import utcnow
