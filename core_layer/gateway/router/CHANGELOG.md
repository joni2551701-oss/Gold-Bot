# CHANGELOG.md — core_layer/gateway/router
...
### Changed
- Converted from flat `router.py` to package `router/` (GEL-001 Strict). No behavioural change; implementation moved intact.
