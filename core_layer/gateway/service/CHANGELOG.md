# CHANGELOG.md — core_layer/gateway/service
...
### Changed
- Converted from flat `service.py` to package `service/` (GEL-001 Strict). No behavioural change; implementation moved intact.
