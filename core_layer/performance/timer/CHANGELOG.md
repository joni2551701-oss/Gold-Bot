# CHANGELOG.md — core_layer/performance/timer
...
### Changed
- Converted from flat `timer.py` to package `timer/` (GEL-001 Strict). No behavioural change; implementation moved intact.
