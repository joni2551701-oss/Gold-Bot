...
database_layer/market_repository/raw_candle_repository.py's own structure (CRUD only, no
...
from database_layer.database_manager.models import init_sync_state_schema
from database_layer.market_repository.sync_state_models import SyncState
