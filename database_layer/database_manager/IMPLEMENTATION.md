...
full schema. `database_layer/market_repository/raw_candle_models.py`'s `from_market_candle()`
...
`backtesting_layer/replay_engine/replay_engine.py`'s fixed historical replay window
