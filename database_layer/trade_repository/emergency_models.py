...
database_layer/audit_log/audit_log_models.py's own shape/naming split: the DB-row
...
Append-only by design (see database_layer/trade_repository/emergency_repository.py): every
