...
Safety Layer Foundation, TASK 2). Mirrors database_layer/audit_log/audit_log_repository.py's
own structure (append-only, no update/delete, idempotent schema init in
__init__) rather than database_layer/journal_repository/runtime_feature_repository.py's
...
from database_layer.database_manager.models import init_emergency_state_schema
from database_layer.trade_repository.emergency_models import EmergencyStateEntry, create_emergency_state_entry
