...
database_layer/market_repository/sync_state_repository.py's own structure (upsert via
...
from database_layer.database_manager.models import init_runtime_feature_schema
from database_layer.journal_repository.runtime_feature_models import RuntimeFeatureRecord
