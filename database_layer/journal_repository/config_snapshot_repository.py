...
database_layer/audit_log/audit_log_repository.py's own structure (append-only, no
...
from database_layer.database_manager.models import init_config_snapshot_schema
from database_layer.journal_repository.config_snapshot_models import ConfigSnapshotRecord
