...
Same registry pattern as `platforms/platform_registry.py`/
...
e.g. "telegram.signal_access_service" -- not a Python import path
...
from platforms.capability_model import PlatformCapability
