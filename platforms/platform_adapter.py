...
turn a `platforms.menu_registry.MenuDefinition` (what `NavigationCore`
...
adapter interface in this repo -- `telegram/reply_keyboard_manager.py`/
`telegram/keyboards.py` are a concrete, Telegram-specific
