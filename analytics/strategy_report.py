...
def _win_rate(win_count: int, loss_count: int) -> float:
    """Same formula and zero-division guard as monitoring/performance.py's PerformanceTracker._win_rate() -- see module docstring."""
...
def build_strategy_report(
    ...
    for strategy_id, records in grouped.items():
        ...
        report[strategy_id] = StrategyPerformanceReport(
            ...
            win_rate=_win_rate(win_count, loss_count),
