...
reachability) and `monitoring.provider_health.check_registry_health()`
...
class SystemMonitor:
    ...
    def record_error(self, message: Optional[str]) -> None:
        """Never raises. Called by `monitoring.error_monitor.ErrorMonitor.capture()`, or any other caller."""
