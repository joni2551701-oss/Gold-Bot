...
| FLOW-019 | Application Services | Application Services | 🟨 | 70% | Worker | **Partial (Production re-audit, 2026-08-05).** Telegram application services (`user_service` va h.k.) jonli (FLOW-001, SSOT'dan o'qiydi). Ammo `platform_layer/platform_service` (PlatformRegistry/MenuRegistry/NavigationCore/PlatformAdapterBase) uchun 0 ta jonli importer -- orphaned Foundation. Eski 100% docs-only edi. Batafsil: `docs/FLOW_017_025_PRODUCTION_REAUDIT.md`. Reja: Sprint P3 (platform_service'ni jonli ulash YOKI rasman Foundation deb qayta tasniflab yopish -- Director qaroriga havola). |
