...
| FLOW-017 | Personal AI Core | GoldBot > Personal AI Core | 🟨 | 60% | Worker | **Partial (Production re-audit, 2026-08-05).** Pipeline advisory `ai_engine.AIAnalyzer -> DecisionEngine` jonli + test qilingan (haqiqiy sub-zanjir). Ammo Personal AI **mahsuloti** (assistant/trading_analyst, Phase 61-66) uchun jonli user-facing Consumer YO'Q -- faqat `ai_status`/`runtime_*` monitoring komandalar `OWNER_COMMANDS`da. Eski 100% docs-only edi. Batafsil: `docs/FLOW_017_025_PRODUCTION_REAUDIT.md`. Reja: Sprint P1 (jonli `/ai_ask` komandasini ulash, yangi feature emas). |
