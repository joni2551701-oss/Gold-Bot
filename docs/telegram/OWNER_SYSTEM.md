...
Owner
 ...
 ├── Broadcast Control      → OWNER_PANEL.md "Broadcast" section (runtime_notifications.py's queue; live delivery loop is the still-open v0.7 gap) + platform_layer/telegram/owner/broadcast_commands.py (Phase 63.0, foundation-only, NOT IMPLEMENTED)
