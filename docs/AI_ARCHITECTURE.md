...
`telegram/` (confirmed by grep, zero matches). `decision/models.py`
...
- **`ai/ai_analyzer.py` → NOT moved.** Five separate production
  ...
  (`core/pipeline.py`, `decision/decision_engine.py`,
  `decision/models.py`, `telegram/signal_formatter.py`, plus
