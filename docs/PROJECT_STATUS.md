...
| Current Flow | FLOW-018 ✅ Completed (2026-08-06, PHASE-02 Production Wiring + Tool-First). Backtesting Engine jonli `/backtest` Telegram Consumer + Backtesting Service (Tool-First, DB-backed) bilan Production'ga ulandi (`docs/FLOW_018_BACKTESTING_PRODUCTION.md`). FLOW-017 ✅ Completed (Personal AI, `/ask`). Keyingisi (GFL-003 Sequential): **FLOW-019** (Application Services — `platform_service`'ni jonli ulash YOKI rasman Foundation deb yopish, Sprint P3 — Director qaroriga havola). Qolgan: FLOW-021-025 🟦 Blueprint. Reja: `docs/FLOW_017_025_PRODUCTION_REAUDIT.md`. |
