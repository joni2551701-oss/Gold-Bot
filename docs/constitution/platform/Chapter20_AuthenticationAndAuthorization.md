...
**Package:** GB-PLATFORM-CONST-020 · **Document:** Chapter20_AuthenticationAndAuthorization.md · **Status:** Approved — GoldBot Platform Constitution v1.0 (Frozen Baseline, PLATFORM-DCR-008)
