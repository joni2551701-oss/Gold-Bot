# IMPLEMENTATION.md -- context_layer/market_structure

## `bos.py`

Classes: `BosDirection`, `BosEvent`

Top-level functions: `detect_bos()`

## `choch.py`

Classes: `ChochDirection`, `ChochEvent`

Top-level functions: `detect_choch()`

## `market_structure.py`

Classes: `SwingType`, `StructureType`, `SwingPoint`, `StructurePoint`

Top-level functions: `detect_swing_points()`, `most_recent_bias()`, `classify_structure()`
