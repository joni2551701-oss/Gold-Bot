# CHANGELOG.md — context_layer/market_structure/bos
...
### Changed
- Converted from flat `bos.py` to package `bos/` (GEL-001 Strict). No behavioural change; implementation moved intact.
