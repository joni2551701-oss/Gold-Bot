...
filter-and-log behavior data/market_data.py's MarketDataNormalizer
...
Relationship to data/market_data.py (read, not modified, this phase):
...
# Kept in sync with data/market_data.py's own expected_deltas and
# data/twelve_data_client.py's INTERVAL_MAP -- a small, deliberate,
