...
(same top-level package) and `data.api_error_classifier` (AC-07/Phase
...
Not imported by `core/pipeline.py`, `data/market_data.py`, or any
...
`data/market_data.py` wiring to actually call `get_provider()`/
