...
provider returned zero candles) that data/twelve_data_client.py's own
...
data/providers/twelve_data_provider.py) call this directly instead of
classify_api_error().
"""
...
def classify_api_error(exception: Exception, module: str = "TwelveDataClient") -> ExternalAPIError:
    ...
    disclosed as such: data/twelve_data_client.py's fetch_candles()
