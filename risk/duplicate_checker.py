...
see risk/account_state_tracker.py's module docstring for the same
...
class DuplicateTradeChecker:
    """Owns the recent-approvals lookup against RiskDecisionRepository -- risk/risk_manager.py never queries the repository directly for this."""
