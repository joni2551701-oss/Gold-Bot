...
Historical Data (`database_layer.market_repository.raw_candle_repository.RawCandleRepository`,
...
class ReplayConfig:
    ...
    `database_layer.market_repository.raw_candle_repository.RawCandleRepository.get_candles_range()`,
