...
`backtesting_layer/statistics/strategy_report.py`'s `StrategyPerformanceReport`
...
if TYPE_CHECKING:
    from backtesting_layer.statistics.equity_curve import EquityPoint
...
def compute_performance_metrics(
    ...
    if equity_curve:
        from backtesting_layer.statistics.equity_curve import max_drawdown as compute_max_drawdown
