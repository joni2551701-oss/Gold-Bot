...
strategies/strategy_manager.py's StrategyManager -- no new strategy is
...
(strategies/liquidity_strategy.py, fvg_strategy.py, amd_strategy.py),
...
# The three strategies strategies/strategy_manager.py's StrategyManager
...
class StrategyRegistry:
    ...
    Never imports strategies/strategy_manager.py or any strategies/*.py
