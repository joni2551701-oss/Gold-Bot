...
trade_monitoring_layer/paper_trading/paper_trade.py (Phase 59 Preparation) already built the
...
EXPIRED, per trade_monitoring_layer/paper_trading/paper_trade.py's own documented definition
...
from trade_monitoring_layer.paper_trading.paper_trade import PaperTradeTransitionResult, close_paper_trade
...
def check_paper_trade_against_candles(
    ...
    candle history itself (e.g. via database_layer/market_repository/raw_candle_repository.py,
