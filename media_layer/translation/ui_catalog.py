...
translation contract `media_layer.translation.translation_manager.TranslationManager`
...
platform_layer/telegram/handlers.py calls instead of returning a literal string.
...
_CATALOG: dict = {
    ...
    # language_handler()). _language_name() (platform_layer/telegram/handlers.py) stays
    ...
    # Phase 1.5 Localized Keyboards -- platform_layer/telegram/keyboards.py button labels
    ...
    # (platform_layer/telegram/reply_keyboard_manager.py). "rkm." prefix distinguishes
    ...
    # platform_layer/telegram/reply_keyboard_manager.py's module docstring).
    "rkm.admin.admins": {
