...
Formats an already-built `ai_layer.knowledge_ai.learning_context.LearningContext` --
never fetches `ai_layer.knowledge_ai.learning_loop.models.LearningRecord` itself. `ai/` already
legitimately builds `LearningContext` internally
(`ai_layer/knowledge_ai/learning_context.py`, Phase 60.6/60.7) from a caller-supplied
...
or `learning/` beyond what `ai_layer/knowledge_ai/learning_context.py` already has.
"""
