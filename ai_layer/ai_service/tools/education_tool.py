...
Queries `ai_layer/knowledge_ai/knowledge_base/registry.py` (Phase 61.3, TASK 3) by key or free-text
...
from ai_layer.knowledge_ai.knowledge_base.registry import get_entry, search
