...
the neutral top-level `ai_layer/ai_service/content/content_types.py` -- it is a cross-cutting
vocabulary the upstream `ai/explanation/` package also needs, and
keeping it here forced a real `ai_layer.explanation_ai ↔ ai.content` circular
