...
extracted here, to a neutral top-level `ai_layer/ai_service/content/content_types.py`, from
...
`ai/explanation/` -- a real `ai_layer.explanation_ai ↔ ai.content` circular
