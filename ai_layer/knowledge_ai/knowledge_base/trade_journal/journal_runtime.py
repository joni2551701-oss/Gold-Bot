...
`ai_layer.knowledge_ai.knowledge_base.trade_journal.access.is_trade_journal_enabled_for()` itself, the
...
from ai_layer.knowledge_ai.knowledge_base.trade_journal.models import TradeJournalEntry, generate_journal_id
