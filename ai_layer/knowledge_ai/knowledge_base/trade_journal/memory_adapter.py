...
future). This module deliberately never imports `ai_layer.knowledge_ai.memory_manager` at all --
...
would use as `ai_layer.knowledge_ai.memory_manager.models.MemoryEntry.key` when it decides to
