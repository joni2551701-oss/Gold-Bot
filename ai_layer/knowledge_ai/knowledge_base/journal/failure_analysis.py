...
def create_failure_analysis_entry(
    ...
    """Pure, deterministic factory -- stamps created_at, same convention as generate_performance_id()'s caller in backtesting_layer/statistics/signal_performance.py."""
