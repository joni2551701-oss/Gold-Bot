...
class RegimeObservation:
    ...
    regime: one of `KNOWN_REGIMES` by convention -- not enforced as an
        ...
        fixed taxonomy yet" posture `ai_layer.knowledge_ai.knowledge_base.journal.failure_analysis.FailureAnalysisEntry.reason`
...
def format_regime_summary(memory: RegimeMemory) -> List[str]:
    ...
    `ai_layer.knowledge_ai.learning_context.build_learning_context()`'s own `regimes=`
