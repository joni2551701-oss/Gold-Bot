...
Classifies a `ai_layer.knowledge_ai.learning_loop.pattern_detector.PatternInsight` into
...
- **Sample Size**: `min(occurrences / MIN_PATTERN_SAMPLE, 1.0)` —
  reuses `ai_layer.knowledge_ai.learning_loop.pattern_detector.MIN_PATTERN_SAMPLE` (20) directly
...
from ai_layer.knowledge_ai.learning_loop.pattern_detector import MIN_PATTERN_SAMPLE, PatternInsight
...
def compute_pattern_confidence(
    ...
    (`ai_layer.knowledge_ai.learning_loop.pattern_detector.detect_patterns()`'s own grouping) --
