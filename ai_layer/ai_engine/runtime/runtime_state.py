...
distinct from `ai_layer.ai_engine.providers.provider_status.HealthStatus` (one
provider's observed health) and `ai_layer.ai_engine.providers.provider_manager.
