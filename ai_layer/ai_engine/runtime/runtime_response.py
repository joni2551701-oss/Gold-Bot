...
class RuntimeResponse:
    ...
    errors: validator errors (empty unless a provider response was
        rejected by `ai_layer.confidence_ai.response_validator.validate_response()`).
    request_id (Phase 61.3, TASK 8): the `ai_layer.ai_service.audit.request_log.AIRequestLogEntry.request_id`
        ...
        to point to). Pass this to `ai_layer.ai_service.audit.trace.trace_request()` to
