...
`ai_layer.ai_service.access.access_control.AccessControl`, `ai_layer.ai_engine.capabilities.capability_manager.CapabilityManager`,
`ai_layer.ai_coordinator.router.AIRouter`, `ai_layer.ai_engine.providers.provider_manager.ProviderManager`,
`ai_layer.ai_engine.providers.provider_health.ProviderHealthTracker`,
`ai_layer.ai_engine.providers.runtime_errors` (TASK 4), `ai_layer.confidence_ai.response_validator`
(TASK 5), `ai_layer.ai_engine.cache.cache_policy`/`ai_layer.ai_engine.cache.response_cache` (TASK 7),
`ai_layer.ai_service.audit.request_log`/`ai_layer.ai_service.audit.response_log` (TASK 8),
`ai_layer.ai_engine.prompts.prompt_manager.PromptManager`.
...
`ai_layer/ai_service/interfaces.py`'s `AIAnalyzerInterface` has always required.
...
from ai_layer.ai_service.audit.provider_stats import compute_daily_usage, evaluate_cost_protection
