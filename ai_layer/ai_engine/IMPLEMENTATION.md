...
`ai_layer.knowledge_ai.learning_loop.models`/`ai_layer.knowledge_ai.learning_loop.pattern_detector`, and
`ai_layer.knowledge_ai.learning_loop.confidence.compute_pattern_confidence` — read-only, no
...
heuristic/model scoring — is still out of scope (`ai_layer/ai_engine/ai_analyzer.py`
