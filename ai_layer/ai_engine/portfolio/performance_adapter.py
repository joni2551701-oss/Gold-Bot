...
`ai_layer.ai_engine.portfolio.portfolio_runtime.PortfolioRuntime.create()`/`update()`
...
`ai_layer.ai_engine.strategy.performance_adapter.performance_record_to_strategy_input()`'s
own "field deliberately omitted" precedent exactly.

This is the one file in `ai/portfolio/` permitted to import
`ai_layer.ai_engine.performance.models` -- `models.py`, `access.py`,
