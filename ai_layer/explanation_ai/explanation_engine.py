...
audit established) and `ai_layer/knowledge_ai/knowledge_base/registry.py`'s entries as prompt
...
from ai_layer.knowledge_ai.knowledge_base.registry import get_entry
