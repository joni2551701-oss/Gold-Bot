...
reads an existing `ai_layer.ai_engine.strategy.models.StrategyRecord` (Phase 66.6,
...
`ai_layer.ai_engine.strategy.models` -- `models.py`, `access.py`, `research_runtime.py`,
