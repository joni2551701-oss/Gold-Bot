...
Read-only facade over `knowledge/registry.py`'s static catalog, same
...
class KnowledgeManager:
    ...
    def search(self, query: str) -> Sequence[KnowledgeEntry]:
        """Case-insensitive substring match over title, summary, and tags -- same matching rule as `knowledge/registry.py`'s own module-level `search()`, applied over this instance's own entry set."""
