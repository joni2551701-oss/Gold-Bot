...
risk_layer/risk_validator/duplicate_checker.py).
"""
...
class AccountStateTracker:
    """Owns the read-modify-write cycle against RiskStateRepository -- risk_layer/risk_engine/risk_manager.py never touches the repository directly."""
