"""
core.gateway -- GoldBot v1.1 Market Data Foundation: Core Gateway Layer
...
from core.gateway.service_breaker import BreakerState, ServiceCircuitBreaker
...
from core.gateway.gateway_context import GatewayContext, new_context, utcnow
from core.gateway.authentication import (
    Authenticator, AllowAllAuthenticator, TokenAuthenticator,
)
from core.gateway.authorization import (
