...
(signal_layer.signal_builder.schema.SignalSchema) and produces a DecisionOutcome carrying the
...
frozen) — the same discipline STEP-08 used with signal_layer/signal_service/manager.py alongside
...
from decision_layer.rule_engine.decision_rules import (
    RuleContext,
    apply_rules,
